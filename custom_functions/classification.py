...
# Adapted from: https://github.com/jirvingphd/how-to-make-successful-movies/blob/streamlit-dev/custom_functions/evaluate.py
...
def jmi_classification_metrics(y_true, y_pred, label='',
...
def jmi_evaluate_classification(model, X_train, y_train, X_test, y_test,
    ...
    results_train = jmi_classification_metrics(y_train, y_train_pred, #verbose = verbose,
    ...
    results_test = jmi_classification_metrics(y_test, y_test_pred, #verbose = verbose,
                                  output_dict=True,figsize=figsize,
